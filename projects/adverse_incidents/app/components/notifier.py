...
def get_incidents():
    ...
    while not stop_thread:
        try:
            response = requests.get(Config.ADVERSE_INCIDENTS_PROVIDER_URL, headers={"x-api-key": Config.ADVERSE_INCIDENTS_PROVIDER_API_KEY})
            ...
            print(f"Waiting {Config.ADVERSE_INCIDENTS_PROVIDER_REFRESH_INTERVAL_SECONDS} seconds to get the next " f"incidents...")
